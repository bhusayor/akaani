    ...
    <article className="art">
      ...
      <div className="art__body" id="artBody">
        ...
        <ul>
          ...
          <li><b>Plan your week.</b> Tell Lu your goal and get a weekly Nigerian meal plan — grocery list included, Sunday market run sorted.</li>
        ...
        <div className="lutip">
          ...
          <div>
            <b>A tip from Lu</b>
            <p>Toast your egusi seeds before grinding — deeper flavour, and you'll use less oil to get the same richness. Your macros will thank you.</p>
          </div>
        </div>
