  ...
  return (
    ...
    <section className="blog" id="blog">
      ...
      <div className="blog__grid">
        ...
        <article className="post">
          <div className="post__img"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/0d/Jollof_%28Jollof-_Rice%29.jpg/1920px-Jollof_%28Jollof-_Rice%29.jpg" alt="Jollof rice" loading="lazy" /><span className="post__arrow">→</span></div>
          <div className="post__body">
